...
public partial class teamsevenphygendbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Question>(entity =>
        {
            ...
            entity.Property(e => e.QuestionSource).HasMaxLength(500);
            entity.Property(e => e.IsCloned).HasDefaultValue(false);
        ...
        modelBuilder.Entity<Solution>(entity =>
        {
            ...
            entity.Property(e => e.Content).IsRequired().HasMaxLength(5000);
            entity.Property(e => e.Explanation).HasMaxLength(10000);
            entity.Property(e => e.PythonScript).HasMaxLength(10000);
            entity.Property(e => e.Mp4Url).HasMaxLength(1000);
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("CURRENT_TIMESTAMP");
            entity.Property(e => e.IsApproved).HasDefaultValue(true);
            entity.Property(e => e.IsMp4Generated).HasDefaultValue(false);
            entity.Property(e => e.IsMp4Reused).HasDefaultValue(false);

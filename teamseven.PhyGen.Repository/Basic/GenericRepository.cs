...
namespace teamseven.PhyGen.Repository.Basic
{
    public class GenericRepository<T> where T : class
    {
        protected teamsevenphygendbContext _context;

        public GenericRepository()
        {
            _context ??= new teamsevenphygendbContext();
        }

        public GenericRepository(teamsevenphygendbContext context)
        {
            _context = context;
        }
